...
/* 
 ...
 odom.child_frame_id = "base_footprint"; // set child frame and set velocity in twist message
...
int main(int argc, char** argv){
 ...
 ros::Subscriber quadenc_sub = nh.subscribe("quadenc",10,quadencCallback);
